 ...
 * en eclipse o netbeans para poder visualizarlo correctamente.
 */
...
public class Parking {
	...
	public void registrarEntradaVehiculo(Vehiculo v) {
		...
		if (plazasDisponibles > 0) {
			...
			v.setFechaEntrada((LocalDateTime) Utils.fechaYHoraAleatoriaAlrededorFechaYHoraActual());
	...
	public void registrarSalidaVehiculo(Vehiculo v) {
		...
		v.setMinutos(Utils.minutosEntreDosFechas((LocalDateTime) v.getFechaEntrada(), salida));
